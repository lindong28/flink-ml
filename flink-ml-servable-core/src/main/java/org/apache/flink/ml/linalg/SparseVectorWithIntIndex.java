...
@PublicEvolving
public class SparseVectorWithIntIndex implements SparseVector {
    // TODO: make it private and replace all usages with getLength().
    // We need a FLIP for these changes.
    public final int n;
    // TODO: make it private and replace all usages with getIndices().
    public int[] indices;
    // TODO: make it private and replace all usages with getValues().
    public double[] values;

    public SparseVectorWithIntIndex(int n, int[] indices, double[] values) {
        this.n = n;
    ...
    @Override
    public long[] getIndicesAsLongArray() {
    ...
    public double get(long i) {
        ...
        int pos = Arrays.binarySearch(indices, (int)i);
        if (pos >= 0) {
            return values[pos];
        }
        return 0.;
    ...
    @Override
    public void set(long ii, double value) {
        // TODO: throw exception if ii exceeds MAX INT.
        int i = (int) ii;
    ...
    public boolean equals(Object o) {
        ...
        SparseVectorWithIntIndex that = (SparseVectorWithIntIndex) o;
        return n == that.n
    ...
    @Override
    public SparseVectorWithIntIndex clone() {
        return new SparseVectorWithIntIndex(n, indices.clone(), values.clone());
    }
}
